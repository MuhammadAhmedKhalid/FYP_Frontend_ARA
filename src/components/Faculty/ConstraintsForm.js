...
function ConstraintsForm({setShowForm}) {
    ...
    return (
        <div className="flexbox-container-y"
            ...
            <div>
                <FacultyNavbar/>
                <p style={{color: 'black', marginTop: '5rem', marginLeft: '1.5rem', cursor: 'pointer'}}
                    onClick={() => setShowForm(false)}>
                    {` < Back `}
                </p>
                <h2 className='center' style={{ color: "#115868", fontSize: 30, marginBottom: '1.5rem' }}>
                    Add Constraints
                </h2>
