...
import { updateAllocatedFaculty } from '../../../../../redux/UpdateAllocatedFaculty/updAllocatedFacultyActions'
...
function UpdAllocatedFaculty({update, setUpdate, data}) {
    ...
    const submitHandler = (e) => {
        ...
        for(let i of allocatedFaculty){
            if(i.allocateFacultyId === data[0]){
                dispatch(updateAllocatedFaculty(i.allocateFacultyId, allocate))
                break
            }
        }
